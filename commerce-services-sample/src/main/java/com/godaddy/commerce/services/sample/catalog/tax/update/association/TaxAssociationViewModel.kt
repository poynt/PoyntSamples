...
//        viewModelScope.launch {
//            val items = suspendCancellableCoroutine<List<TaxAssociation>?> {
...
//    }
//
//    fun addProductToTax(product: CatalogProduct) {
//        hideProductsDialog()
//        execute {
...
//            items.add(
//                AssociationItems(TaxConstants.Association.TYPE_PRODUCT, id = UUID.fromString(product.product.id))
//            )
