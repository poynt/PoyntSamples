...
//import com.godaddy.commercecore.models.Products
...
//                    ProductParams.FILTER_BY_PRODUCT_COLUMNS to FilterBy(CatalogContract.InventoryInfo.Columns. "'1'", FilterBy.ComparisonOperator.NOT)
//
//
//                )
